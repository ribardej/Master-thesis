...
export function RSANumericAnimation() {
  ...
  const isCoprime = gcd(eVal, phi) === 1;
  ...
  const getDescription = () => {
    switch (step) {
      case 0: return "1. Primes: Your friend chooses two private prime numbers p and q.";
      case 1: return "2. Keys Generation: Your friend computes the Modulus n and Totient φ(n).";
      case 2: return "3. Public Exponent: Your friend picks e coprime to φ(n), and shares Public Key (e, n).";
      case 3: return "4. Private Exponent: Your friend computes his Private Key d = e⁻¹ mod φ(n).";
      case 4: return "5. Encryption: You want to send a message M. You encrypt it using your friend's Public Key.";
      case 5: return "6. Transmission: You send the Ciphertext C over the insecure channel.";
      case 6: return "7. Decryption: Your friend uses his Private Key d to recover the original message M.";
      default: return "";
    }
  };
  ...
  return (
    <div className="flex flex-col items-center w-full max-w-4xl mx-auto p-4 bg-white rounded-xl shadow-sm border border-gray-100 text-sm overflow-hidden">
      ...
      <div className="flex flex-wrap w-full items-center justify-between mb-4 px-2">
        <h3 className="text-lg font-bold text-gray-800 m-0">RSA Example</h3>
      ...
      <div className="flex w-full items-stretch justify-center gap-2 min-h-[350px] relative">
        ...
        <div className="flex-1 flex flex-col items-center bg-pink-50/50 border border-pink-200 rounded-xl p-3 z-10 w-[30%]">
          ...
          <div className="flex flex-col gap-3 w-full">
            ...
            <div className={`transition-all duration-500 w-full bg-white p-2 rounded shadow-sm border border-pink-100 flex flex-col items-center ${step >= 4 ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-4'}`}>
              <span className="text-[10px] uppercase font-bold text-gray-500 mb-1">Encrypt with your friend's Public Key</span>
        ...
        <div className="flex-1 flex flex-col items-center bg-gray-50 border-x border-gray-200 px-2 py-3 relative w-[40%]">
          ...
          <div className={`transition-opacity duration-500 bg-white border border-blue-300 shadow-sm rounded px-3 py-2 flex flex-col items-center w-full max-w-[160px] ${step >= 2 ? 'opacity-100' : 'opacity-0'}`}>
            <span className="text-[10px] uppercase font-bold text-blue-600 border-b border-gray-100 pb-1 mb-1 w-full text-center">Your friend's Public Key</span>
