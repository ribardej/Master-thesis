  ...
  return (
    <div className="w-full max-w-3xl mx-auto p-8 bg-gray-50 rounded-xl border border-gray-200 my-8 shadow-sm">
      <div className="flex justify-between items-center mb-12">
        <h3 className="text-xl font-bold text-gray-800 m-0">Analogy for Diffie-Hellman Key Exchange Principle</h3>
        ...
        <div className="absolute top-1/2 left-[15%] right-[15%] h-20 -translate-y-1/2 z-20 pointer-events-none">
          <style>
            {`
              ...
              .animate-slide-left {
                animation: slideLeft 3.3s ease-in-out forwards;
              }
              .animate-slide-right {
                animation: slideRight 3.3s ease-in-out forwards;
              }
            `}
          </style>
